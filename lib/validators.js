...
module.exports = {
  ...
  include: (patterns) => all(patterns.map((pattern) => pattern instanceof RegExp || pattern === null)),
  exclude: (patterns) => all(patterns.map((pattern) => pattern instanceof RegExp || pattern === null)),
